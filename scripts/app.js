...
(function(exports) {
  ...
  var showSeries = function (dictShow) {
      return new Data_Show.Show(function (v) {
          return "{ index: " + (Data_Show.show(Data_Show.showArray(Data_Show.showNumber))(v.value0) + ("\x0a, values: " + (Data_Show.show(Data_Show.showArray(dictShow))(v.value1) + "\x0a}")));
      });
  };
...
(function(exports) {
  ...
  var LoadSeries = (function () {
      function LoadSeries(value0) {
          this.value0 = value0;
      };
      LoadSeries.create = function (value0) {
          return new LoadSeries(value0);
      };
      return LoadSeries;
  })();
  var renderNavibar = Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("navbar navbar-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-header") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-brand"), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("Time Series Lab") ]) ]) ]) ]);
  var renderFooter = Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.hr_, Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://github.com/timeserieslab/timeserieslab.github.io") ])([ Halogen_HTML_Core.text("Github.com") ]) ]);
  var renderExamples = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Example Time Series") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-primary"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Small dataset") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-primary"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Anomalies 60K") ]), Halogen_HTML_Core.text(" "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-primary"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Turkey daily electricity demand") ]) ]) ]);
  var renderChart = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Data_TimeSeries.showSeries(Data_Show.showNumber)))(state.series)) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderNavibar, renderChart(state), renderExamples, renderFooter ]);
  };
  var initialState = {
      loading: false, 
  ...
  var $$eval = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("https://timeserieslab.github.io/testdata/small.csv")))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $10.loading = false;
                  $10.series = Data_Array.head(Data_TimeSeries_IO.fromCsv(v1.response));
                  return $10;
              }))(function () {
  ...
  var page = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
