...
(function(exports) {
  ...
  var renderChart = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel panel-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel-body") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.series)) ]) ]);
  };
