...
(function(exports) {
  ...
  var showMetadata = function (xs) {
      return function __do() {
          $foreign.setNodeText("startDate")("Start date")();
          $foreign.setNodeText("endDate")("End date")();
          $foreign.setNodeText("pointNumber")(Data_Show.show(Data_Show.showInt)(Data_TimeSeries.length(xs)))();
          return $foreign.setNodeText("timeRes")("Time distance between points")();
      };
  };
