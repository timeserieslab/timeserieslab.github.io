...
(function(exports) {
  ...
  var render = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 94, column 1 - line 95, column 1: " + [ v.constructor.name ]);
  };
  ...
  var updateState = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof ZoomIn) {
              ...
              $18.endIndex = Data_Ord.max(Data_Ord.ordNumber)(endIndex)(minEndIndex);
              return $18;
          };
          if (v1 instanceof ZoomOut) {
              ...
              $21.endIndex = Data_Ord.min(Data_Ord.ordNumber)(endIndex)(maxEndIndex);
              return $21;
          };
          if (v1 instanceof NextFrame) {
              ...
              $24.startIndex = v.startIndex + frame;
              $24.endIndex = v.endIndex + frame;
              return $24;
          };
          if (v1 instanceof PrevFrame) {
              ...
              $27.startIndex = v.startIndex - frame;
              $27.endIndex = v.endIndex - frame;
              return $27;
          };
          if (v1 instanceof Reindex) {
              ...
              $30.series = Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.reindex(dt))(v.series);
              return $30;
          };
          if (v1 instanceof RemoveAnomalies) {
              ...
              $33.series = new Data_Maybe.Just(ys);
              return $33;
          };
          throw new Error("Failed pattern match at Main line 50, column 1 - line 52, column 33: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
