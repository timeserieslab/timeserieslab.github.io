  ...
  var updateState = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Reindex) {
              ...
              $29.series = Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.reindex(dt))(v.series);
              return $29;
          };
          throw new Error("Failed pattern match at Main line 48, column 1 - line 50, column 33: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
