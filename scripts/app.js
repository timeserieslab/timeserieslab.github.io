...
(function(exports) {
  ...
  var renderExamples = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Example Time Series") ]), Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("60K dataset with anomalies "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Load") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Small dataset "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Load") ]) ]), Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("Turkey daily electricity demand "), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Load") ]) ]) ]) ]);
  var renderChart = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.series)) ]);
  };
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("https://timeserieslab.github.io/testdata/small.csv")))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $9.loading = false;
                  $9.series = new Data_Maybe.Just(v1.response);
                  return $9;
              }))(function () {
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Page.page)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
