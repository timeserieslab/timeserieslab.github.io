...
(function(exports) {
  ...
  var reindex$prime = function (__copy_dt) {
      return function (__copy_v) {
          return function (__copy_out) {
              ...
              var __tco_v;
              var __tco_out;
              function __tco_loop(dt, v, out) {
                  if (v.length === 0) {
                      __tco_done = true;
                      return out;
                  };
                  var y = Data_Maybe.fromMaybe(dpZero)(Data_Array.last(out));
                  var x = Data_Maybe.fromMaybe(dpZero)(Data_Array.head(v));
                  var ts = Data_Maybe.fromMaybe([  ])(Data_Array.tail(v));
                  var nidx = dpIndex(y) + dt;
                  var tx = dpIndex(x) - nidx;
                  var ty = nidx - dpIndex(y);
                  var mu = (ty / (tx + ty)) * dpValue(x) + (tx / (tx + ty)) * dpValue(y);
                  var $138 = nidx < dpIndex(x);
                  if ($138) {
                      __tco_dt = dt;
                      __tco_v = v;
                      __tco_out = Data_Array.snoc(out)(dataPoint(nidx)(mu));
                      return;
                  };
                  var $139 = nidx === dpIndex(x);
                  if ($139) {
                      __tco_dt = dt;
                      __tco_v = ts;
                      __tco_out = Data_Array.snoc(out)(x);
                      return;
                  };
                  __tco_dt = dt;
                  __tco_v = ts;
              ...
              while (!__tco_done) {
                  __tco_result = __tco_loop(dt, v, out);
                  dt = __tco_dt;
                  v = __tco_v;
                  out = __tco_out;
              };
  ...
  var reindex = function (dt) {
      return function (xs) {
          var dp = Data_Maybe.fromMaybe(dpZero)(head(xs));
          return fromDataPoints(reindex$prime(dt)(toDataPoints(xs))([ dp ]));
      };
  };
...
(function(exports) {
  ...
  var train = function (xs) {
      ...
      var ys = Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(1)(1))(LinearAlgebra_Matrix.fromArray(Data_Array.length(vs))(1)(vs));
      return Model.create(Learn_Unsupervised_OutlierDetection.train(ys));
  };
  var predictOutliers = function (v) {
      return function (xs) {
          var vs = Data_TimeSeries.values(xs);
          ...
          return Learn_Unsupervised_OutlierDetection.predict(v.value0)(vs$prime);
      };
  };
  var removeOutliers = function (model) {
      return function (xs) {
          var ys = predictOutliers(model)(xs);
          var vs = Data_TimeSeries.values(xs);
          var v = Data_Maybe.fromMaybe(0.0)(Data_Array.head(vs));
          var ys2 = Data_Array.zip(ys)(Data_Array.cons(v)(vs));
          var f = function (x) {
              return function (v1) {
                  var $7 = v1.value0 < 1.0e-2;
                  if ($7) {
                      return v1.value1;
                  };
                  return x;
          ...
          return Data_TimeSeries.series(Data_TimeSeries.index(xs))(Data_Array.zipWith(f)(vs)(ys2));
      };
  };
  exports["removeOutliers"] = removeOutliers;
  exports["train"] = train;
})(PS["Data.TimeSeries.Anomalies"] = PS["Data.TimeSeries.Anomalies"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var formatTimeDelta$prime = function (dt) {
      ...
      throw new Error("Failed pattern match at Views line 48, column 1 - line 56, column 1: " + [ dt.constructor.name ]);
  };
...
(function(exports) {
  ...
  var Data_Semiring = PS["Data.Semiring"];
  var Data_TimeSeries = PS["Data.TimeSeries"];
  var Data_TimeSeries_Anomalies = PS["Data.TimeSeries.Anomalies"];
  ...
  var render = function (v) {
      ...
      if (v.series instanceof Data_Maybe.Just) {
          return function __do() {
              Views.plotSeries(toChartData(v.series.value0)(v.startIndex)(v.endIndex))();
              Views.showRange(v.startIndex)(v.endIndex)();
              return Views.showMetadata(v.series.value0)();
          };
      };
      throw new Error("Failed pattern match at Main line 98, column 1 - line 99, column 1: " + [ v.constructor.name ]);
  };
  ...
  var updateState = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof ZoomIn) {
              ...
              $19.endIndex = Data_Ord.max(Data_Ord.ordNumber)(endIndex)(minEndIndex);
              return $19;
          };
          if (v1 instanceof ZoomOut) {
              ...
              $22.endIndex = Data_Ord.min(Data_Ord.ordNumber)(endIndex)(maxEndIndex);
              return $22;
          };
          ...
          if (v1 instanceof PrevFrame) {
              ...
              $28.startIndex = v.startIndex - frame;
              $28.endIndex = v.endIndex - frame;
              return $28;
          };
          if (v1 instanceof Reindex) {
              var dt = Data_Maybe.fromMaybe(1000.0)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.resolution)(v.series));
              var $31 = {};
              for (var $32 in v) {
              ...
              $31.series = Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.reindex(dt))(v.series);
              return $31;
          };
          if (v1 instanceof RemoveAnomalies) {
              var xs = Data_Maybe.fromMaybe(Data_TimeSeries.empty)(v.series);
              var model = Data_TimeSeries_Anomalies.train(xs);
              var ys = Data_TimeSeries_Anomalies.removeOutliers(model)(xs);
              var $34 = {};
              for (var $35 in v) {
              ...
              $34.series = new Data_Maybe.Just(ys);
              return $34;
          };
          if (v1 instanceof GroupBy) {
              ...
              $37.series = Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.groupBy(v1.value0)(LinearAlgebra_Vector.sum(Data_Semiring.semiringNumber)))(v.series);
              return $37;
          };
          throw new Error("Failed pattern match at Main line 52, column 1 - line 54, column 33: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
