...
(function(exports) {
  ...
  var renderUploadSection = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel panel-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel-body") ])([ Halogen_HTML_Core.text("Select CSV file"), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputFile.value), Halogen_HTML_Events.onChange(Halogen_HTML_Events.input_(LoadSeries.create)) ]) ]) ]) ]);
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderNavibar, renderChart(state), renderUploadSection ]);
  };
  var initialState = {
  ...
  var $$eval = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
          return {
              series: new Data_Maybe.Just("loaded")
          };
      }))(function () {
  ...
  exports["renderUploadSection"] = renderUploadSection;
})(PS["Page"] = PS["Page"] || {});
(function(exports) {
  // Generated by psc version 0.10.7
  "use strict";
