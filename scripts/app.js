  ...
  var myButton = (function () {
      var render = function (state) {
          var label = (function () {
              ...
              throw new Error("Failed pattern match at Button line 34, column 15 - line 35, column 5: " + [ state.constructor.name ]);
          })();
      ...
      var $$eval = function (v) {
          if (v instanceof Toggle) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var nextState = !v1;
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(nextState))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new Toggled(nextState)))(function () {
...
(function(exports) {
  ...
  var renderNavibar = Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("navbar navbar-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-header") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-brand"), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("Time Series Lab") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-primary navbar-btn navbar-left"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(LoadSeries.create)) ])([ Halogen_HTML_Core.text("Upload CSV") ]) ]) ]) ]);
  var renderChart = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel panel-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("panel-body") ])([ Halogen_HTML.slot(ButtonSlot.value)(Button.myButton)(Data_Unit.unit)(Halogen_HTML_Events.input(HandleButton.create)), Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(state.series)) ]) ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ renderNavibar, renderChart(state) ]);
  };
  var initialState = {
      loading: false, 
  ...
  var $$eval = function (v) {
      if (v instanceof HandleButton) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
      if (v instanceof LoadSeries) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("https://timeserieslab.github.io/testdata/small.csv")))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $15.loading = false;
                      $15.series = new Data_Maybe.Just(v1.response);
                      return $15;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
      ...
      throw new Error("Failed pattern match at Page line 89, column 8 - line 96, column 10: " + [ v.constructor.name ]);
  };
  ...
  var page = Halogen_Component.parentComponent(ordButtonSlot)({
