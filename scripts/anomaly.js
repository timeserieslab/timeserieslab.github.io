...
(function(exports) {
  ...
  var showAnomalies = function (xs) {
      ...
      var predictions = Learn_Unsupervised_OutlierDetection.predict(model)(td);
      var s4 = Data_Functor.map(Data_Functor.functorArray)(function (p) {
          return p < 5.0e-2;
      })(predictions);
      return $foreign.setNodeText("anomalies")(Data_Show.show(Data_Show.showInt)(Data_Array.length(Data_Array.filter(Control_Category.id(Control_Category.categoryFn))(s4))));
  };
  var formatTimeDelta$prime = function (dt) {
      ...
      throw new Error("Failed pattern match at Commons.Views line 52, column 1 - line 60, column 1: " + [ dt.constructor.name ]);
  };
  ...
  var render = function (v) {
      ...
      if (v.series instanceof Data_Maybe.Just) {
          return function __do() {
              ...
              return Commons_Views.showAnomalies(v.series.value0)();
          };
      };
      throw new Error("Failed pattern match at AnomalyMain line 90, column 1 - line 91, column 1: " + [ v.constructor.name ]);
  };
  ...
  var updateState = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof RemoveAnomalies) {
              ...
              $29.series = new Data_Maybe.Just(ys);
              return $29;
          };
          throw new Error("Failed pattern match at AnomalyMain line 50, column 1 - line 52, column 33: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
