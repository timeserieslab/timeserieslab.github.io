...
(function(exports) {
  ...
  var showAnomalies = function (v) {
      if (v instanceof Data_Maybe.Nothing) {
          return $foreign.setNodeText("anomalies")("");
      };
      if (v instanceof Data_Maybe.Just) {
          return $foreign.setNodeText("anomalies")(Data_Show.show(Data_Show.showInt)(v.value0));
      };
      throw new Error("Failed pattern match at Commons.Views line 74, column 1 - line 75, column 1: " + [ v.constructor.name ]);
  };
  var formatTimeDelta$prime = function (dt) {
      ...
      throw new Error("Failed pattern match at Commons.Views line 50, column 1 - line 58, column 1: " + [ dt.constructor.name ]);
  };
  ...
  exports["showAnomalies"] = showAnomalies;
  ...
  var replicate = function (r) {
      return function (c) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at LinearAlgebra.Matrix line 38, column 1 - line 39, column 38: " + [ r.constructor.name, c.constructor.name, v.constructor.name ]);
          };
      };
  };
  ...
  var fromArray = function (r) {
      return function (c) {
          return function (vs) {
              ...
              throw new Error("Failed pattern match at LinearAlgebra.Matrix line 53, column 1 - line 54, column 39: " + [ r.constructor.name, c.constructor.name, vs.constructor.name ]);
          };
      };
  };
...
(function(exports) {
  ...
  exports["complCumulative"] = complCumulative;
  exports["cumulative"] = cumulative;
})(PS["Statistics.Distribution"] = PS["Statistics.Distribution"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Data_EuclideanRing = PS["Data.EuclideanRing"];
  ...
  exports["erf"] = erf;
  exports["erfc"] = erfc;
})(PS["Numeric.SpecFunctions"] = PS["Numeric.SpecFunctions"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Data_Show = PS["Data.Show"];
  var $$Math = PS["Math"];
  var Numeric_SpecFunctions = PS["Numeric.SpecFunctions"];
  var Prelude = PS["Prelude"];
  var Statistics_Distribution = PS["Statistics.Distribution"];
  var Statistics_Sample = PS["Statistics.Sample"];        
  var ND = (function () {
      function ND(value0) {
          this.value0 = value0;
  ...
  exports["fromSample"] = fromSample;
  exports["normalDistr"] = normalDistr;
  exports["standard"] = standard;
  exports["distrNormal"] = distrNormal;
})(PS["Statistics.Distribution.Normal"] = PS["Statistics.Distribution.Normal"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Prelude = PS["Prelude"];
  var Statistics_Distribution = PS["Statistics.Distribution"];
  var Statistics_Distribution_Normal = PS["Statistics.Distribution.Normal"];        
  var Model = (function () {
  ...
  var predict1 = function (v) {
      return function (vs) {
          var prob = function (distr) {
              return function (v1) {
                  return 2.0 * Data_Ord.min(Data_Ord.ordNumber)(Statistics_Distribution.cumulative(Statistics_Distribution_Normal.distrNormal)(distr)(v1))(Statistics_Distribution.complCumulative(Statistics_Distribution_Normal.distrNormal)(distr)(v1));
              };
          };
          return Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Semiring.mul(Data_Semiring.semiringNumber))(1.0)(Data_Array.zipWith(prob)(v.value0)(vs));
      };
  };
  ...
  exports["predict1"] = predict1;
  exports["train"] = train;
})(PS["Learn.Unsupervised.OutlierDetection"] = PS["Learn.Unsupervised.OutlierDetection"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Data_Array = PS["Data.Array"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_TimeSeries = PS["Data.TimeSeries"];
  var Learn_Unsupervised_OutlierDetection = PS["Learn.Unsupervised.OutlierDetection"];
  var LinearAlgebra_Matrix = PS["LinearAlgebra.Matrix"];
  var Prelude = PS["Prelude"];
  var Statistics_Sample = PS["Statistics.Sample"];        
  var Model = (function () {
  ...
  var train = function (xs) {
      var vs = Data_TimeSeries.values(xs);
      var mat = Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(1)(1))(LinearAlgebra_Matrix.fromArray(Data_Array.length(vs))(1)(vs));
      return new Model(Learn_Unsupervised_OutlierDetection.train(mat), Statistics_Sample.mean(vs));
  }; 
  var predictOutliers = function (model) {
      return function (xs) {
          var vs = Data_TimeSeries.values(xs);
          var vs$prime = Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(1)(1))(LinearAlgebra_Matrix.fromArray(Data_Array.length(vs))(1)(vs));
          return Learn_Unsupervised_OutlierDetection.predict(model)(vs$prime);
      };
  };
  var removeOutliers = function (v) {
      return function (xs) {
          var ys = predictOutliers(v.value0)(xs);
          var vs = Data_TimeSeries.values(xs);
          var f = function (x) {
              return function (p) {
                  var $7 = p < 1.0e-2;
          ...
          return Data_TimeSeries.series(Data_TimeSeries.index(xs))(Data_Array.zipWith(f)(vs)(ys));
      };
  };
  exports["removeOutliers"] = removeOutliers;
  exports["train"] = train;
})(PS["Data.TimeSeries.Anomaly"] = PS["Data.TimeSeries.Anomaly"] || {});
(function(exports) {
    "use strict";
...
})(PS["Data.TimeSeries.Time.Convert"] = PS["Data.TimeSeries.Time.Convert"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var $foreign = PS["Data.TimeSeries.Time.Convert"];
  var Data_Maybe = PS["Data.Maybe"];
  var Global = PS["Global"];        
...
(function(exports) {
  ...
  var Data_TimeSeries = PS["Data.TimeSeries"];
  var Data_TimeSeries_Time = PS["Data.TimeSeries.Time"];
  var Data_TimeSeries_Time_Convert = PS["Data.TimeSeries.Time.Convert"];
  var Data_Tuple = PS["Data.Tuple"];
  var Global = PS["Global"];
  var Prelude = PS["Prelude"];
  ...
  var parseRow = function (str) {
      ...
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.head(fields))(Data_TimeSeries_Time_Convert.parseISOTime))(function (v) {
...
(function(exports) {
  ...
  var Data_Semiring = PS["Data.Semiring"];
  var Data_TimeSeries = PS["Data.TimeSeries"];
  var Data_TimeSeries_Anomaly = PS["Data.TimeSeries.Anomaly"];
  ...
  var FindAnomalies = (function () {
      function FindAnomalies() {

      };
      FindAnomalies.value = new FindAnomalies();
      return FindAnomalies;
  })();
  var RemoveAnomalies = (function () {
      function RemoveAnomalies() {

      };
      RemoveAnomalies.value = new RemoveAnomalies();
  ...
  var render = function (v) {
      ...
      if (v.series instanceof Data_Maybe.Just) {
          return function __do() {
              ...
              Commons_Views.showMetadata(v.series.value0)();
              return Commons_Views.showAnomalies(v.anomalyCount)();
          };
      };
      throw new Error("Failed pattern match at AnomalyMain line 97, column 1 - line 98, column 1: " + [ v.constructor.name ]);
  };
  ...
  var initState = {
      ...
      startIndex: 0.0, 
      endIndex: 0.0, 
      anomalyCount: Data_Maybe.Nothing.value
  };
  ...
  var countAnomalies = function (xs) {
      var td = Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(1)(1))(LinearAlgebra_Matrix.fromArray(Data_TimeSeries.length(xs))(1)(Data_TimeSeries.values(xs)));
      var model = Learn_Unsupervised_OutlierDetection.train(td);
      var ys = Learn_Unsupervised_OutlierDetection.predict(model)(td);
  ...
  var updateState = function (state) {
      return function (v) {
          if (v instanceof SeriesLoaded) {
              ...
              $19.series = xs;
              $19.startIndex = indexVal(xs)(Data_TimeSeries.head);
              $19.endIndex = indexVal(xs)(Data_TimeSeries.last);
              return $19;
          };
          if (v instanceof ZoomIn) {
              var minEndIndex = state.startIndex + 5.0 * Data_Maybe.fromMaybe(1000.0)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_TimeSeries.resolution)(state.series));
              var endIndex = state.startIndex + (state.endIndex - state.startIndex) / 2.0;
              var $23 = {};
              for (var $24 in state) {
              ...
              $23.endIndex = Data_Ord.max(Data_Ord.ordNumber)(endIndex)(minEndIndex);
              return $23;
          };
          if (v instanceof ZoomOut) {
              var maxEndIndex = indexVal(state.series)(Data_TimeSeries.last);
              var endIndex = state.endIndex + (state.endIndex - state.startIndex);
              var $26 = {};
              for (var $27 in state) {
              ...
              $26.endIndex = Data_Ord.min(Data_Ord.ordNumber)(endIndex)(maxEndIndex);
              return $26;
          };
          if (v instanceof NextFrame) {
              var frame2 = indexVal(state.series)(Data_TimeSeries.last) - state.endIndex;
              var frame1 = state.endIndex - state.startIndex;
              ...
              $29.startIndex = state.startIndex + frame;
              $29.endIndex = state.endIndex + frame;
              return $29;
          };
          if (v instanceof PrevFrame) {
              var frame2 = state.startIndex - indexVal(state.series)(Data_TimeSeries.head);
              var frame1 = state.endIndex - state.startIndex;
              var frame = Data_Ord.min(Data_Ord.ordNumber)(frame1)(frame2);
              var $32 = {};
              for (var $33 in state) {
              ...
              $32.startIndex = state.startIndex - frame;
              $32.endIndex = state.endIndex - frame;
              return $32;
          };
          if (v instanceof FindAnomalies) {
              var $35 = {};
              for (var $36 in state) {
              ...
              $35.anomalyCount = Data_Functor.map(Data_Maybe.functorMaybe)(countAnomalies)(state.series);
              return $35;
          };
          if (v instanceof RemoveAnomalies) {
              var xs = Data_Maybe.fromMaybe(Data_TimeSeries.empty)(state.series);
              var model = Data_TimeSeries_Anomaly.train(xs);
              var ys = Data_TimeSeries_Anomaly.removeOutliers(model)(xs);
              var $38 = {};
              for (var $39 in state) {
              ...
              $38.series = new Data_Maybe.Just(ys);
              $38.anomalyCount = Data_Maybe.Nothing.value;
              return $38;
          };
          throw new Error("Failed pattern match at AnomalyMain line 54, column 1 - line 57, column 35: " + [ state.constructor.name, v.constructor.name ]);
      };
  };
  ...
  exports["FindAnomalies"] = FindAnomalies;
  exports["RemoveAnomalies"] = RemoveAnomalies;
  exports["initState"] = initState;
  exports["main"] = main;
  exports["render"] = render;
  exports["updateState"] = updateState;
})(PS["AnomalyMain"] = PS["AnomalyMain"] || {});
PS["AnomalyMain"].main();
