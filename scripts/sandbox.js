...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var renderNavibar = function (title) {
      return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.class_("navbar navbar-default") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container-fluid") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-header") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-brand"), Halogen_HTML_Properties.href("index.html") ])([ Halogen_HTML_Core.text("Time Series Lab") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("navbar-text") ])([ Halogen_HTML_Core.text(title) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-primary navbar-btn"), Halogen_HTML_Properties.attr("data-toggle")("modal"), Halogen_HTML_Properties.attr("data-target")("#loadModal") ])([ Halogen_HTML_Core.text("Load data") ]) ]) ]);
  };
  var renderLoadModal = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal fade"), Halogen_HTML_Properties.id_("loadModal"), Halogen_HTML_Properties.tabIndex(-1 | 0), Halogen_HTML_Properties_ARIA.role("dialog"), Halogen_HTML_Properties_ARIA.labelledBy("myModalLabel") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-dialog"), Halogen_HTML_Properties_ARIA.role("document") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-content") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-header") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("close"), Halogen_HTML_Properties.attr("type")("button"), Halogen_HTML_Properties.attr("data-dismiss")("modal"), Halogen_HTML_Properties_ARIA.label("Close") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties_ARIA.hidden("true") ])([ Halogen_HTML_Core.text("\xd7") ]) ]), Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.class_("modal-title") ])([ Halogen_HTML_Core.text("Load data") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-body") ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Load from the disk") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("btn btn-primary btn-file") ])([ Halogen_HTML_Core.text("Select CSV file"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.attr("style")("display: none;"), Halogen_HTML_Properties.attr("type")("file"), Halogen_HTML_Properties.attr("data-dismiss")("modal"), Halogen_HTML_Properties.id_("fileInput") ]) ]) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Load from URL") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.attr("type")("text"), Halogen_HTML_Properties.attr("size")("50"), Halogen_HTML_Properties.id_("urlText"), Halogen_HTML_Properties.placeholder("URL") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Load") ]) ]), Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("Example Time Series") ]), Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Small dataset") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Electricity demand") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Rainfall") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Anomalies 60K") ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modal-footer") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("btn btn-default"), Halogen_HTML_Properties.attr("type")("button"), Halogen_HTML_Properties.attr("data-dismiss")("modal") ])([ Halogen_HTML_Core.text("Close") ]) ]) ]) ]) ]);
  exports["renderLoadModal"] = renderLoadModal;
  exports["renderNavibar"] = renderNavibar;
})(PS["Component.Navibar"] = PS["Component.Navibar"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
...
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Component_Navibar = PS["Component.Navibar"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Component_Navibar.renderNavibar("Sandbox"), Component_Navibar.renderLoadModal, renderButton(state) ]);
  };
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at SandboxMain line 58, column 8 - line 67, column 23: " + [ v.constructor.name ]);
  };
  var myButton = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
